...
def fire_bullet():
    ...
    try:
        sound =pygame.mixer.Sound("/Users/liujiu/python/flight simulator/material/laser.wav")
        sound.play()
...
def level_2():
    ...
    background = pygame.image.load("/Users/liujiu/python/flight simulator/material/dddd.png")
